...
\simpleslideimage{clipart/AnalogueAM.png}{Analogni amplitudno moduliran (AM) signal}

\simpleslideimage{clipart/DigitalAM.png}{Digitalni amplitudno moduliran (AM) signal}
...
\simpleslideimage{clipart/OmniPattern2dB.png}{Omni antena 2 dBi}

\simpleslideimage{clipart/OmniPattern5dB.png}{Omni antena 5 dBi}

\simpleslideimage{clipart/PanelPattern.png}{Panel antena}

\simpleslideimage{clipart/SectorPattern.png}{Sektor antena}
