...
9h-12h
   ...
   \item Duh pobude in zgodba \wlanslovenija
   \item Osnove brezžičnih komunikacij
   \item Predstavitev radioamaterstva \& SOTA
   \end{itemize}
   12h-13h
   \begin{itemize}
   \item Kosilo, prijava na praktični del.
  \end{itemize}
13h
   \begin{itemize}
   \item Popularne brezžične komunikacije
   \item Vzpostavitev točk \wlanslovenija
   \item Sodelovanje, vprašanja in prosta debata 
\end{itemize}
}{}
